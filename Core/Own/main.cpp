...
//        lcd.ShowString(24,30,(uint8_t*)"LCD_W:",RED,WHITE,16,0);
//        lcd.ShowIntNum(72,30,LCD_W,3,RED,WHITE,16);
//        lcd.ShowString(24,50,(uint8_t*)"LCD_H:",RED,WHITE,16,0);
//        lcd.ShowIntNum(72,50,LCD_H,3,RED,WHITE,16);
//        lcd.ShowFloatNum1(20,80,t,4,RED,WHITE,16);
//        t+=0.11;

//        lcd.ShowPicture(65, 80, 40, 40, gImage_1);
        ++num;
//        lcd.ShowIntNum(20, 120, sec, 4, RED, WHITE, 16);
